...
interface DataTableProps<TData extends EnrollmentApplication, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends EnrollmentApplication, TValue>({
  columns,
  data,
  ...
  const table = useReactTable({
    ...
    getRowId: (row) => row.enrollment_application_id,
  });
